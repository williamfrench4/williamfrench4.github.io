...
*/
  ...
  },
  {
    ...
    dark_theme: 0,
    article_hide_selector: '.tp-active, .fbs-auth__container',
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.css-18kh1s1-Paragraph, .css-oqk0mc-Blockquote, .css-xbvutc-Paragraph, .gray-darkest, .cStoSw, .dOUYsl, .WSJTheme-module--text--37ld_QSx, .WSJTheme-module--text--Cws65LRA, .WSJTheme-module--headline--J5926iIY, h1, h2, tspan, .bigTop__caption',
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.clay-subheader, .clay-subheader_fancy, .manual-article .manual-article-link, h1, p, figcaption, time, .by-authors, .credit',
...
},
{
  ...
  },
  {
    ...
    article_hide_selector: '.ad_wrapper, .ars-sub-app, .share-links, .pullbox, #darticle-footer-wrap, #action_button_container, .superscroll-pager',
