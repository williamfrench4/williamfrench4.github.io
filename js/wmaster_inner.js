...
const sites_data = [
  {
    ...
    article_theme_background_selector: '.bcColumn, .cColumn, .App__app, .main, .g-graphic, .wf-unreal-interactive-graphic,' + selector_for_elements_with_a_class_that_starts_with('elementStyles-sectionHeader-- elementStyles-recirculation-- Card-story--'), // NYT dark theme
