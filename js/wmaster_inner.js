...
*/
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.cStoSw, .dOUYsl, .WSJTheme-module--text--37ld_QSx, .WSJTheme-module--text--Cws65LRA, .WSJTheme-module--headline--J5926iIY, h1, h2, tspan, .bigTop__caption',
  ...
  },
  {
    ...
    article_theme_background_selector: '.jeAcgq.jeAcgq.jeAcgq, .ihhMJk.ihhMJk.ihhMJk, .eubavC.eubavC',
