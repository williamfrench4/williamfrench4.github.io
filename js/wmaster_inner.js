...
const sites_data = [
  {
    ...
    homepage_css: '.css-1g8r0to, .css-1bvxxoj, .css-j7dtq5 {display: block} .g-home-fader, .css-1bcp99t, .css-1hs4eoy, .css-11kuxu4, .css-i3v2ch {max-width: 30%; max-height: 30%; padding: 0 0 20% 0} div[data-testid="masthead-desktop-logo"] {filter: invert(70%) sepia(100%) hue-rotate(65deg) saturate(7)} div:has("#top-wrapper")',
    homepage_hide_selector: '.css-oeful5, .css-dwrnad, .css-sxmela, .css-1u3a8ua, .css-1bcp99t, .css-1g8bx4t, .css-1xaqcky, .css-djiuqn, .css-1q9wuj9, .css-16ddx3c, .css-1vap5ws, #masthead-placeholder, .masthead-cap-container, .masthead.theme-in-content, div.editions.tab, #nytint-hp-watching, #site-index .section-header, #markets, .all-sections-button, #mini-navigation, #WelcomeAd_optly, .css-rpp6l6, .css-wu78io, video,' + selector_for_elements_with_a_class_that_starts_with('BlockAdvert-topAd--'),
...
*/
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.kQxnTl, .klOfMA, .grsixU, .eCQuey, .fYICFM, .fTlKaZ, .fTlKaZ.body__container p.has-dropcap.has-dropcap__lead-standard-heading::first-letter',
