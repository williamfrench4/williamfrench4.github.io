...
const sites_data = [
  ...
  },
  {
    ...
    article_hide_selector: '#webui-ribbon, .mega-nav, .articleTypeLogo, #full-header, #slimline-header, #share_tools, #share-target, .style--header-34vuYLYT-W0F3y22D9Vjuk, #article_tools, .carousel-container, .type-InsetNewsletterSignup, .wsj-modern-ad-container',
