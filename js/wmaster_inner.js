...
const sites_data = [
  ...
  },
  {
    ...
    */
    ...
    article_theme_foreground_selector: '.fc-item__content, .content, .fc-item__standfirst, ul > li, .d-comment__body blockquote', //'.content__dateline, div.explainer, .quoted',
