...
const sites_data = [
  ...
  },
  {
    ...
    article_hide_selector: '.mega-nav, .articleTypeLogo, #full-header, #slimline-header, .style--header-34vuYLYT-W0F3y22D9Vjuk, #article_tools, .carousel-container, .type-InsetNewsletterSignup, .wsj-modern-ad-container',
