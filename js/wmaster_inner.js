...
const theme_link_foreground_color             = '#59f'
...
const sites_data = [
  {
    ...
    article_theme_background_selector: '.css-1iamamn, .css-18qm4m2, .css-1xecbzu, .css-ue2vli, .css-7gyv9j, .css-f2fzwx, #articleBody, #articleBody:after, .bcColumn, .cColumn, .App__app, .main, .g-section, .g-graphic, .wf-unreal-interactive-graphic, .guide-content, .rad-article, .rad-story-body, .g-story, .css-f2fzwx, .css-1aor85t, .css-18ow4sz,' + selector_for_elements_with_a_class_that_starts_with('elementStyles-sectionHeader-- elementStyles-recirculation-- Card-story--'), // NYT dark theme
    ...
    dtheme_selector: 'body, #masthead, .searchsubmit', // NYT dark theme
...
*/
  ...
  },
  {
    ...
    */
    ...
    article_theme_foreground_selector: '.content__main-column--interactive p, [data-gu-name="standfirst"]>div, .dcr-zjgnrw > div, .css-xmt4aq, .css-1h6ikvu, .css-ig5cd, h1, .fc-item__content, .content, .fc-item__standfirst, ul > li, .d-comment__body blockquote', //'.content__dateline, div.explainer, .quoted',
  ...
  },
  {
    ...
    article_css: 'html {overflow: visible} .live-grid {display: block} dwp-ad {visibility: hidden} .powa-wrapper {filter: none} section>div>div {min-height: 0} body {overflow: scroll} .w-100 {filter: none} .article-body>div {padding: 0} #main-content {background-image: none} #et-nav {position: absolute}.headline {font-family: sans-serif} a, .powerpost-header, .layout_article #top-content {border-bottom: none} p {line-height: 155%} body {overflow-y: visible} .fixed-image {position: static} .g-artboard img {border-bottom: 30px solid white} .g-artboard p {color: black; background-color: transparent} .bg-none {background-color: transparent} .note-button {padding: 0; box-shadow: none} .chain-wrapper {background-color: #500} .pg-visual, .photo-section-img {opacity: 1}' +
      ...
      selector_for_elements_with_id_that_starts_with('dclk-studio-creative_') + ' {visibility: hidden}' +
    ...
    homepage_hide_selector: '.slideshow-container, .flex-feature, .flex, .pb-f-homepage-brandconnect-sidebar, .section-story-photo-1, #main-navigation-right', //, .standard-chain img, .opinions-chain img',
    ...
    customize () {
      ...
      regularize_links(window, 'https://www.washingtonpost.com')
    }
  },
  {
  ...
  },
  {
    ...
    dark_theme: 0,
    article_hide_selector: 'iframe, ad-wx-ws, .bxc.bx-base.bx-impress',
  },
  {
  ...
  },
  {
    ...
    article_hide_selector: 'nav, #paywall, gpt-ad, .ad-boxinjector-wrapper, .fancy-box-wrap, c-non-metered-nudge, .module-related.video, .js-inject-promo, .social-kit-top, .article-tools, .callout, .pullquote, .c-nudge__container,' + selector_for_elements_with_a_class_that_starts_with('NonMeteredNudge_root__ adform-adbox- GptAd_ ArticleInjector_'),
    theme_background_selector: '#site',
    article_theme_background_selector: '.article-body blockquote',
    article_theme_foreground_selector: selector_for_elements_with_a_class_that_starts_with('ArticleBody_root__ ArticleDek_root__ ArticleTitle_root__'),
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.css-xbvutc-Paragraph, .gray-darkest, .cStoSw, .dOUYsl, .WSJTheme-module--text--37ld_QSx, .WSJTheme-module--text--Cws65LRA, .WSJTheme-module--headline--J5926iIY, h1, h2, tspan, .bigTop__caption',
    ...
    article_hide_selector: '.share-menu, .sharedStyles__ShareMenuContainer-sc-1ext442-10, .style--header-wrapper-3KS0vHEBLQWIH5Ne-XG256, #webui-ribbon, .mega-nav, .articleTypeLogo, #full-header, #slimline-header, #share_tools, #share-target, .style--header-34vuYLYT-W0F3y22D9Vjuk, #article_tools, .carousel-container, .type-InsetNewsletterSignup, .wsj-modern-ad-container,' + selector_for_elements_with_a_class_that_starts_with('WSJTheme-module--newcards__wrapper--') + selector_for_elements_with_a_class_that_starts_with('sharedStyles__ShareMenuContainer-'),
  ...
  },
  {
    ...
    article_css: 'html {overflow-y: scroll} body {position: relative} blockquote, blockquote p {' + theme_foreground_rule + 'padding: 0 0 0 14px; border-left: 1px solid #3a3} blockquote:before {border-top: none} .mediaplay-image-figcaption {text-align: left} nav.rubric-wrap svg>path:last-child {fill: white} .article .primary-area:before {background: #000}', // "Intelligencer" in Daily Intelligencer logo
  ...
  },
  {
    ...
    article_theme_foreground_selector: 'div.article__body, h1, .body__container p.has-dropcap.has-dropcap__lead-standard-heading::first-letter,' + selector_for_elements_with_a_class_that_starts_with('CaptionText-'),
    d: '.body__container, .brPuMO, .bfHtpC, .kASsHv, .gymDyQ, .frQdTm.body__container p.has-dropcap.has-dropcap__lead-standard-heading::first-letter, .frQdTm, .irSTVw, .cEIrom, .cDNYEs, .kQxnTl, .klOfMA, .grsixU, .eCQuey, .fYICFM, .fTlKaZ, .fTlKaZ.body__container p.has-dropcap.has-dropcap__lead-standard-heading::first-letter' + selector_for_elements_with_a_class_that_starts_with('BodyWrapper-'),
