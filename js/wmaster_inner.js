...
*/
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.cEIrom, .cDNYEs, .kQxnTl, .klOfMA, .grsixU, .eCQuey, .fYICFM, .fTlKaZ, .fTlKaZ.body__container p.has-dropcap.has-dropcap__lead-standard-heading::first-letter',
