...
*/
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.gray-darkest, .cStoSw, .dOUYsl, .WSJTheme-module--text--37ld_QSx, .WSJTheme-module--text--Cws65LRA, .WSJTheme-module--headline--J5926iIY, h1, h2, tspan, .bigTop__caption',
