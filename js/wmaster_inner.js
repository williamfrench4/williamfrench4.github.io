...
const sites_data = [
  {
    ...
    article_theme_background_selector: '.css-18qm4m2, .css-1xecbzu, .css-ue2vli, .css-7gyv9j, .css-f2fzwx, body, #articleBody, #articleBody:after, .bcColumn, .cColumn, .App__app, .main, .g-section, .g-graphic, .wf-unreal-interactive-graphic, .guide-content, .rad-article, .rad-story-body, .g-story, .css-f2fzwx, .css-1aor85t' + selector_for_elements_with_a_class_that_starts_with('elementStyles-sectionHeader-- elementStyles-recirculation-- Card-story--'), // NYT dark theme
