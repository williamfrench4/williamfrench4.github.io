...
const sites_data = [
  ...
  },
  {
    ...
    article_hide_selector: '#adBlockerContainer, #paywall-banner, .persist-nav, .sticky-social-buttons, .inline-newsletter',
