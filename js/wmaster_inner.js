...
const sites_data = [
  {
    ...
    article_hide_selector: ('#NYT_MAIN_CONTENT_1_REGION, .css-y1f5ai, .css-9tf9ac, .g-ad, .css-1wspfld, .css-i29ckm, .css-uw59u, .css-10cldcv, .css-1r214gk, figure.sizeLarge, .expanded-dock, #c-col-editors-picks, .live-blog-above-main-content, .css-1bd8bfl, #gateway-content, #top-wrapper,  #bottom-wrapper, .css-1q1hscp, .css-13pd83m, .NYTAppHideMasthead, div[data-testid="inline-message"], div[data-testid="standard-dock"],' + selector_for_elements_with_id_that_starts_with('ad-') + selector_for_elements_with_id_that_starts_with('story-ad-')),
...
*/
  ...
  },
  {
    ...
    article_theme_foreground_selector: '.cDNYEs, .kQxnTl, .klOfMA, .grsixU, .eCQuey, .fYICFM, .fTlKaZ, .fTlKaZ.body__container p.has-dropcap.has-dropcap__lead-standard-heading::first-letter',
