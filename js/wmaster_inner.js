...
const sites_data = [
  {
    ...
    article_hide_selector: (
      '.live-blog-above-main-content, .css-1bd8bfl, #gateway-content, #top-wrapper,  #bottom-wrapper, .css-1q1hscp, .css-13pd83m, .NYTAppHideMasthead, div[data-testid="inline-message"], div[data-testid="recirculation"],' + selector_for_elements_with_id_that_starts_with('ad-') + selector_for_elements_with_id_that_starts_with('story-ad-')),
    ...
    unwanted_query_fields: 'section surface fellback req_id imp_id algo mtrref action clickSource comments contentCollection contentPlacement index hp label module pgtype _r ref referringSource region rref smid smtyp src type version WT.nav WT.z_jog hF vS utm_campaign utm_content utm_medium utm_source t target mcubz gwh gwt imp_id variant',
  ...
  },
  {
    ...
    article_hide_selector: '#paywall, .c-non-metered-nudge, .module-related.video, .js-inject-promo, .social-kit-top, .article-tools, .callout, .pullquote, .c-nudge__container,' + selector_for_elements_with_a_class_that_starts_with('NonMeteredNudge_root__'),
    ...
    article_css: 'body {overflow: scroll; position: static} figure.lead-img .img {outline: none} .article-cover-extra {padding-bottom: 0; border-bottom: none}',
  ...
  },
  {
    ...
    article_theme_foreground_selector: 'h1, p, figcaption, time, .by-authors, .credit',
  ...
  },
  {
    ...
    article_hide_selector: '.interstitial,' + selector_for_elements_with_a_class_that_starts_with('persistent- MainHeader__topBarItems___ MainHeader__topBar MainHeader__collapsed___ Layout__social___ RecirculationMostPopular__default___ GrowlerFailsafe__'),
