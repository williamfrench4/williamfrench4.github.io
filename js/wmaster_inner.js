...
const sites_data = [
  {
    ...
    homepage_css: '.css-1bvxxoj, .css-j7dtq5 {display: block} .css-1hs4eoy, .css-11kuxu4, .css-i3v2ch {max-width: 30%; max-height: 30%; padding: 0 0 20% 0} div[data-testid="masthead-desktop-logo"] {filter: invert(70%) sepia(100%) hue-rotate(65deg) saturate(7)} div:has("#top-wrapper")',
