...
const sites_data = [
  ...
  },
  {
    ...
    homepage_hide_selector: '.pb-f-homepage-brandconnect-sidebar, .section-story-photo-1, #main-navigation-right', //, .standard-chain img, .opinions-chain img',
  ...
  },
  {
    ...
    article_hide_selector: '.c-non-metered-nudge, .module-related.video, .js-inject-promo, .social-kit-top, .article-tools, .callout, .pullquote, .c-nudge__container',
