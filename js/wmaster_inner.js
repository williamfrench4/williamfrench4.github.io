...
const sites_data = [
  ...
  },
  {
    ...
    article_hide_selector: '#paywall, .c-non-metered-nudge, .module-related.video, .js-inject-promo, .social-kit-top, .article-tools, .callout, .pullquote, .c-nudge__container',
